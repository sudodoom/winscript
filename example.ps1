...
function SecurityPolicies {
    ...
    Set-ItemProperty -Path $polpath -Name "MinimumPasswordAge" -Value $minimumPasswordAge
    ...
    Set-ItemProperty -Path $polpath -Name "LockoutDuration" -Value $lockoutDurationSeconds
    ...
    Set-ItemProperty -Path $polpath -Name "ConsentPromptBehaviorAdmin" -Value 2 #5
    Set-ItemProperty -Path $polpath -Name "PromptOnSecureDesktop" -Value 1
    ...
    Set-ItemProperty -Path "$lsapath\FIPSAlgorithmPolicy" -Name "Enabled" -Value 1

    Set-ItemProperty -Path $polpath -Name "DontDisplayLastUserName" -Value 1
    Set-ItemProperty -Path $polpath -Name "DontDisplayUserName" -Value 1
    
    Set-ItemProperty -Path $polpath -Name "EnableInstallerDetection" -Value 1
    Set-ItemProperty -Path $polpath -Name "EnableSecureUIAPaths" -Value 1
    Set-ItemProperty -Path $polpath -Name "EnableUIADesktopToggle" -Value 1
    Set-ItemProperty -Path $polpath -Name "InactivityTimeoutSecs" -Value 600
    Set-ItemProperty -Path $polpath -Name "NoConnectedUser" -Value 1
    ...
    Set-ItemProperty -Path $lsapath -Name "LimitBlankPasswordUse" -Value 1
